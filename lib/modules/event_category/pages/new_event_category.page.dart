...
class NewEventCategoryPageState extends State<NewEventCategoryPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<EventCategoryViewModel>.reactive(
        viewModelBuilder: () => EventCategoryViewModel(context, VMType.create, null),
        onViewModelReady: (vm) async => await vm.initialize(pageActions: [PageAction(
            title: "Salva",
            isMain: true,
            onTap: () async {
              if (_formKey.currentState!.validate()) {
                await vm.createEventCategory();
