...
class EditEventCategoryPage extends StatefulWidget {
  const EditEventCategoryPage({super.key, required this.id});

  final String id;


  @override
  State<EditEventCategoryPage> createState() => EditEventCategoryPageState();
}

class EditEventCategoryPageState extends State<EditEventCategoryPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<EventCategoryViewModel>.reactive(
        viewModelBuilder: () => EventCategoryViewModel(context, VMType.edit, widget.id),
          ...
          PageAction(
              ...
              onTap: () async {
                if (_formKey.currentState!.validate()) {
                  await vm.updateEventCategory(widget.id);
                          ...
                          children: [
                            ...
                            ResponsiveGridItem(
                              ...
                              child: ClFilePicker.single(
                                initialFile: CLMedia(fileUrl: vm.eventCategory.imageUrl),
