...
class NewStoreCategoryPageState extends State<NewStoreCategoryPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<StoreCategoryViewModel>.reactive(
        viewModelBuilder: () => StoreCategoryViewModel(context, VMType.create, null),
