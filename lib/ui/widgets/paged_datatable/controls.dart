...
class _TextFieldCell<TType extends Object> extends HookWidget {
  ...
  Widget build(BuildContext context) {
    var focusNode = useFocusNode();
    var textController = useTextEditingController(text: initialValue);
    ...
    return GestureDetector(
      onDoubleTap: () async {
        ...
        String? newText = await showDialog(
          ...
          builder:
              (context) => _EditableTextFieldOverlay(
                position: rect,
                    ...
                    children: [
                      Expanded(
                        child: CLTextField(
                          ...
                          validators: validator != null ? [(String? value) => validator!(value)] : null,
                          maxLines: 12,
                          isTextArea: true,
                        ),
                      ),
