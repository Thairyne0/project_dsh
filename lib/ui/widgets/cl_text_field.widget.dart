...
class CLTextFieldState extends State<CLTextField> {
    ...
    if (widget.capitalize) {
      widget.controller.addListener(() {
        ...
        if (text.isNotEmpty) {
          ...
          if (newText != text) {
            // Aggiorna il testo mantenendo la posizione del cursore
  ...
  Widget build(BuildContext context) {
    // Se è un widget Quill, restituisci il layout specifico
    if (widget.isQuill) {
      return Column(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: Sizes.small),
                GestureDetector(
                  onTap: () => quillFocusNode.requestFocus(),
                  child: QuillEditor(
                    config: QuillEditorConfig(minHeight: 200),
                    controller: widget.quillController!,
