import 'package:project_dsh/modules/events/modules/event_category/pages/edit_event_category.page.dart';
import 'package:project_dsh/modules/events/modules/event_category/pages/event_category.page.dart';
import 'package:project_dsh/modules/events/modules/event_category/pages/new_event_category.page.dart';
import 'package:project_dsh/modules/events/modules/event_category/pages/view_event_category.page.dart';
...
class EventCategoryModule extends Module {
  @override
  ...
  List<ModularRoute> get routes => [
        ...
        ChildRoute.build(
            ...
            params: ["id"],isVisible: false),
        ChildRoute.build(
            route: EventCategoryRoutes.editEventCategory,
            childBuilder: (context, state) => EditEventCategoryPage(id: state.pathParameters["id"]!),
            params: ["id"],
            isVisible: false),
        ChildRoute.build(route: EventCategoryRoutes.newEventCategory, childBuilder: (context, state) => const NewEventCategoryPage(), isVisible: false),
      ];
}
