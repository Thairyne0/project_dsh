...
class EditBrandPage extends StatefulWidget {
  ...
  @override
  createState() => EditBrandPageState();
}

class EditBrandPageState extends State<EditBrandPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<BrandViewModel>.reactive(
        viewModelBuilder: () => BrandViewModel(context, VMType.edit, widget.id),
              ...
              PageAction(
                  ...
                  onTap: () async {
                    if (_formKey.currentState!.validate()) {
                      await vm.updateBrand(widget.id);
                              ...
                              ResponsiveGrid(
                                ...
                                children: [
                                  ...
                                  ResponsiveGridItem(
                                    lg: 100,
                                    xs: 100,
                                    child: CLTextField.textArea(controller: vm.descriptionTEC, labelText: "Descrizione", validators: [Validators.required]),
                                  ),
                                  ResponsiveGridItem(
                                    lg: 50,
                                    xs: 100,
                                    child: ClFilePicker.single(
                                      initialFile: CLMedia(fileUrl: vm.brand.imageUrl),
